...
BEGIN
	...
	here : LOOP
		...
		VALUES(CONCAT('age001',cnt), '1111', CONCAT('abc',cnt,'@naver.com'), CONCAT('힐따기요',cnt), 'm' , CONCAT((1960+FLOOR(RAND() * 32)),10+(FLOOR(RAND() * 3)),10+(FLOOR(RAND() * 18))), "default.png", 0, 0, 0, 1, "2023-01-09",0,0,0);
...
BEGIN 
    ...
    here : LOOP 
       ...
       VALUES(CONCAT('m001',cnt), 'qna', '2023-01-13 11:26:02', 'java가 뭔가요?',
